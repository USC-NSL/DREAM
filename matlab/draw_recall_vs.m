...
x(:,:,2)=load_metric('E:/enl/measurement/DynamicMonitor/outputserver/output00/0.010_1000000_a+3-6/HHHMetrics.csv');
x(:,:,3)=load_metric('E:/enl/measurement/DynamicMonitor/outputserver/output00/0.010_1000000_a+6-9/HHHMetrics.csv');
x(:,:,4)=load_metric('E:/enl/measurement/DynamicMonitor/outputserver/output00/0.010_1000000_a+9-12/HHHMetrics.csv');
